...
\begin{center}
  \begin{tikzpicture}[%
    ...
    \node [draw=none,fill=none,below=-1mm of n1] {$\vdots$};
    \node [draw=none,fill=none,below=-1mm of n2] {$\vdots$};
    \node [draw=none,fill=none,below=-1mm of n3] {$\vdots$};
    \node [draw=none,fill=none,below=-1mm of n4] {$\vdots$};
    \node [draw=none,fill=none,below=-1mm of n5] {$\vdots$};
  \end{tikzpicture}
\end{center}
%
